module Views.PlayerRegistrationView exposing (view, Msg(..), Model, init, update)
...
update msg model =
  case msg of
    ...
    Register ->
      let
        trimmed = String.trim model.nameInput
        nameExists = List.member trimmed model.registeredPlayers
      in
